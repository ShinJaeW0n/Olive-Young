...
<head>
	...
	<!-- CSS -->
	<link rel="stylesheet" href="css/userCss/usercommon.css">
	<link rel="stylesheet" href="css/userCss/my1.css">
	<link rel="stylesheet" href="css/userCss/joindone.css" />
...
<body>
	...
	<section class="clearFix">
		...
		<div class="joinSection_body">
			<div class="bodyUp">
				<p>올리브영 회원가입이 <span style="color: #F27370;">완료</span>되었습니다.</p>
				<small><span style="color: #28283C;">${join_name }</span> 님 회원가입을 축하합니다.</small>
				<small>고객님의 올리브영 아이디는 <span style="color: #28283C;">${join_id }</span> 입니다.</small>
			</div>
			<div class="bodyDown">
				<p>고객님께서는 통합회원으로 가입되었습니다.</p>
				<small>통합회원으로 가입된 경우 올리브영 쇼핑몰과 오 프라인에서 제공하는 멤버쉽 혜택을 함께 이용하실 수 있습니다.</small>
			</div>
		</div>
	</section>
	...
	<div class="joinArticle_B">
		<div class="joinBtn">
			<div class="btn_all btn_join" id="modalJoin_btn" onClick="location.href='userLogin.bo'">로그인</div>
			<div class="btn_all btn_cancel" onClick="location.href='home.jsp'">메인으로</div>
		</div>
	</div>
	...
	<footer id="footer">
		<div class="footerT">
			<div class="foot_menu">
				<ul>
					<li class="m1"><a href="mailto:shjaewon.dev@gmail.com" class="mail">신재원</a>	</li>		
					<li class="m2"><a href="mailto:eunjuoh.dev@gmail.com" class="mail">오은주</a>	</li>		
					<li class="m2"><a href="mailto:qmffkrql1108@gmail.com" class="mail">최은비</a>	</li>		
				</ul>
			</div>		
		</div>	
		<div class="footerM">
			<div class="footInfo">
				<div class="address">
					...
					<p>
					 ...
					 <p>
					 	<span>전자우편주소 : &nbsp;<a href="mailto:jkdmswn02023@naver.com" class="mail" style="color: #999999">jkdmswn02023@naver.com</a></span> 
					 </p>
				</div>
