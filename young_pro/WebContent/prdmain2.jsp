			...
			<a style="color: rgb(0,0,0);" href="#">
				<img class="bgImg" alt=""  src="https://image.drjart.com/img/008/1595983667066.jpg" style="height: 100%;"/>
					<div class="con">
						...
						<p class="subtxt">
						월간 올영 오직 회원만 즐길 수 있는 특별한 파티
						<br />
						럭키럭키한 이벤트를 지금 바로 확인해보세요!
						<br />
						</p>
	...
	<div class="item slick-active">
		<a href="#" style="color: rgb(255,255,255);">
			...
			<div class="con">
				...
				<p class="subtxt">
				올리브영 멤버십만 받을 수 있는 특별 구매 금액대별 사은품
				</p>
				<span class="btn btnType5 btnSizeM" style="border-color:inherit; color: inherit;">
					<span>자세히 보기</span>
				</span>
...
<div class="section recommend" id="recommend">
 ...
 <div class="section review">
 	<div class="title">
 		<h3><a href="main.do">베스트 포토리뷰</a></h3>
 		<p class="subtit">
			...
			<div class="footerT">
				...
				<div class="sitemap">
					...
					<li class="dep1 util">
						...
						<ul>
							<c:if test="${id==null}">
							<li><a href="joinAgreeForm.jsp">회원가입</a></li>
							</c:if>
